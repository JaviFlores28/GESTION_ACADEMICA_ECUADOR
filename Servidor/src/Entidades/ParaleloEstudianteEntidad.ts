...
class ParaleloEstudiante {
    ...
    constructor(PRLL_EST_ID: string, PRLL_ID: string, MTR_ID: string, ESTADO: string, CREADOR_ID: string, FECHA_CREACION?: Date | undefined) {
    ...
    isValid(): boolean {
      return !!this.PRLL_EST_ID && !!this.PRLL_ID && !!this.MTR_ID && !!this.ESTADO && !!this.CREADOR_ID;
    }
}
