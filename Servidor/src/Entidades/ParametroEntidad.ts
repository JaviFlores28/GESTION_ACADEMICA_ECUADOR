...
class Parametro {
  PRMT_ID: string;
    ...
    constructor(PRMT_ID: string, PRMT_NOM: string, PRMT_DESCR: string, PRMT_URL_IMG: string, ESTADO: number, CREADOR_ID: string, FECHA_CREACION?: Date | undefined) {
...
isValid(): boolean {
  return !!this.PRMT_ID && !!this.PRMT_NOM && !!this.PRMT_DESCR && !!this.PRMT_URL_IMG && !!this.CREADOR_ID;
}
