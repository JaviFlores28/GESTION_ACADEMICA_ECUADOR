...
class CalificacionesCualitativasEntidad {
  CAL_ID: string;
    ...
    ESTADO: number;
    CREADOR_ID: string;    
    constructor(CAL_ID: string, PRF_ASG_PRLL_ID: string, EST_CRS_PRLL_ID: string, PRD_ID: string, CALIFICACION: string, ESTADO: number, CREADOR_ID: string) {
       this.CAL_ID = CAL_ID;
    ...
    toArrayInsert(): any[] {
      return [this.CAL_ID,this.PRF_ASG_PRLL_ID,this.EST_CRS_PRLL_ID,this.PRD_ID,this.CALIFICACION,this.ESTADO,this.CREADOR_ID];
    } 
    toArrayUpdate(): any[] {
