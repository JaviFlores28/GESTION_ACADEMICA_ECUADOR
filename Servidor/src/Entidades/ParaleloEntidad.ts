...
class Paralelo {
  PRLL_ID: string;
    ...
    constructor(PRLL_ID: string, PRLL_NOM: string, CRS_ID: string, AL_ID: string, ESTADO: number, CREADOR_ID: string, FECHA_CREACION?: Date | undefined) {
...
isValid(): boolean {
  return !!this.PRLL_ID && !!this.PRLL_NOM && !!this.CRS_ID && !!this.AL_ID && !!this.CREADOR_ID;
}
