class ProfesorAsignaturaParaleloEntidad {
  ...
  constructor(PRF_ASG_PRLL_ID: string, ASG_ID: string, PRF_ID: string, AL_ID: string, CRS_ID: string, PRLL_ID: string, ESTADO: number, CREADOR_ID: string) {
  ...
  toArrayInsert(): any[] {
    return [this.PRF_ASG_PRLL_ID, this.ASG_ID, this.PRF_ID, this.AL_ID, this.CRS_ID, this.PRLL_ID, this.ESTADO, this.CREADOR_ID];
  }
