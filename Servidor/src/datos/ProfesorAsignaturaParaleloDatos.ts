...
class ProfesorAsignaturaParaleloDatos {
  ...
  static sqlSelect: string = `SELECT * FROM vista_profesor_asignatura_paralelo ORDER BY ESTADO DESC`;
  static sqlGetById: string = 'SELECT * FROM profesor_asignatura_paralelo WHERE PRF_ASG_PRLL_ID = ?';
  static sqlGetEnabled: string = 'SELECT * FROM vista_profesor_asignatura_paralelo WHERE ESTADO = 1 ORDER BY ESTADO DESC';
  ...
  static async insert(profesor_asignatura_paralelo: ProfesorAsignaturaParaleloEntidad): Promise<Respuesta> {
    try {
      ...
      const newProfesorAsignaturaParalelo = new ProfesorAsignaturaParaleloEntidad(profesor_asignatura_paralelo.PRF_ASG_PRLL_ID, profesor_asignatura_paralelo.PRF_ID, anio, profesor_asignatura_paralelo.ASG_ID, profesor_asignatura_paralelo.CRS_ID, profesor_asignatura_paralelo.PRLL_ID, profesor_asignatura_paralelo.ESTADO, profesor_asignatura_paralelo.CREADOR_ID);
