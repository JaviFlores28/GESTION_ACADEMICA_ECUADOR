...
CREATE TABLE `PROFESOR` (
  `PRF_ID` VARCHAR(36) NOT NULL PRIMARY KEY,
...
CREATE TABLE `ESTUDIANTE` (
  `EST_ID` VARCHAR(36) NOT NULL PRIMARY KEY,
...
CREATE TABLE `CURSO` (
  `CRS_ID` VARCHAR(36) NOT NULL PRIMARY KEY,
  `CRS_NOM` VARCHAR(10) NOT NULL,
...
CREATE TABLE `AREA` (
  `AREA_ID` VARCHAR(36) NOT NULL PRIMARY KEY,
  `AREA_NOM` VARCHAR(300) NOT NULL,
  `ESTADO` enum ('Activo', 'Inactivo') NOT NULL,
  `CREADOR_ID` VARCHAR(36) NOT NULL,
  `FECHA_CREACION` DATETIME NOT NULL DEFAULT current_timestamp(),
  FOREIGN KEY (`CREADOR_ID`) REFERENCES `USUARIO` (`USR_ID`)
...
CREATE TABLE `ASIGNATURA` (
  `ASG_ID` VARCHAR(36) NOT NULL PRIMARY KEY,
  `ASG_NOM` VARCHAR(50) NOT NULL,
  `ASG_TIPO` ENUM('CUALITATIVA', 'CUANTITATIVA') NOT NULL,
  `AREA_ID` VARCHAR(36) NOT NULL,
  `CRS_ID` VARCHAR(36) NOT NULL,
  `ESTADO` enum ('Activo', 'Inactivo') NOT NULL,
  `CREADOR_ID` VARCHAR(36) NOT NULL,
  `FECHA_CREACION` DATETIME NOT NULL DEFAULT current_timestamp(),
  FOREIGN KEY (`CREADOR_ID`) REFERENCES `USUARIO` (`USR_ID`),
...
CREATE TABLE `ANIO_LECTIVO` (
  `AL_ID` VARCHAR(36) NOT NULL PRIMARY KEY,
  `AL_NOM` VARCHAR(30) NOT NULL,
  `AL_INICIO` DATE NOT NULL,
  `AL_FIN` DATE NOT NULL,
  `AL_POR_PRD` INT NOT NULL,
  `AL_POR_EXAM` INT NOT NULL,
  `CLFN__MIN_APR` FLOAT NOT NULL,
  `CLFN__MIN_PERD` FLOAT NOT NULL,
...
CREATE TABLE `PARALELO` (
  `PRLL_ID` VARCHAR(36) NOT NULL PRIMARY KEY,
...
CREATE TABLE `MATRICULA` (
  `MTR_ID` VARCHAR(36) NOT NULL PRIMARY KEY,
  `CRS_ID` VARCHAR(36) NOT NULL,
...
CREATE TABLE `PARALELO_ESTUDIANTE` (
  `PRLL_EST_ID` VARCHAR(36) NOT NULL PRIMARY KEY,
  `PRLL_ID` VARCHAR(36) NOT NULL,
  `MTR_ID` VARCHAR(36) NOT NULL,
  `ESTADO` enum ('Activo', 'Inactivo') NOT NULL,
  `CREADOR_ID` VARCHAR(36) NOT NULL,
  `FECHA_CREACION` DATETIME NOT NULL DEFAULT current_timestamp(),
...
CREATE TABLE `PROFESOR_ASIGNATURA_PARALELO` (
  `PRF_ASG_PRLL_ID` VARCHAR(36) NOT NULL PRIMARY KEY,
  `ASG_ID` VARCHAR(36) NOT NULL,
  `PRF_ID` VARCHAR(36) NOT NULL,
  `PRLL_ID` VARCHAR(36) NOT NULL,
  `ESTADO` enum ('Activo', 'Inactivo') NOT NULL,
  `CREADOR_ID` VARCHAR(36) NOT NULL,
  `FECHA_CREACION` DATETIME NOT NULL DEFAULT current_timestamp(),
...
CREATE TABLE `PERIODO` (
  `PRD_ID` VARCHAR(36) NOT NULL PRIMARY KEY,
...
CREATE TABLE `CALIFICACIONES_PARCIALES` (
  `CAL_ID` VARCHAR(36) NOT NULL PRIMARY KEY,
  `PRF_ASG_PRLL_ID` VARCHAR(36) NOT NULL,
  `PRLL_EST_ID` VARCHAR(36) NOT NULL,
  `PRCL_ID` VARCHAR(36) NOT NULL,
  ...
  FOREIGN KEY (`PRLL_EST_ID`) REFERENCES `PARALELO_ESTUDIANTE` (`PRLL_EST_ID`),
...
CREATE TABLE `CALIFICACIONES_PERIODO` (
  ...
  `PRF_ASG_PRLL_ID` VARCHAR(36) NOT NULL,
  `PRLL_EST_ID` VARCHAR(36) NOT NULL,
  `CALIFICACION_CNTVA` FLOAT NOT NULL,
  `CALIFICACION_CLTVA` CHAR(1) NOT NULL,
  `PRD_ID` VARCHAR(36) NOT NULL,
  `ESTADO` enum ('Activo', 'Inactivo') NOT NULL,
  `CREADOR_ID` VARCHAR(36) NOT NULL,
  `FECHA_CREACION` DATETIME NOT NULL DEFAULT current_timestamp(),
...
CREATE TABLE `PARAMETRO` (
  `PRMT_ID` VARCHAR(36) NOT NULL PRIMARY KEY,
